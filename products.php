...
<body> 
	...
	<div class="banner banner1">
		<div class="container">
			<h2><strong>Welcome To  </strong><span class="style1">Furniture World</span> </strong></h2> 
		</div>
	</div> 
	<!-- breadcrumbs -->
			...
			<div class="w3ls_mobiles_grids">
				...
				<div class="col-md-12 w3ls_mobiles_grid_right">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						...
						$s=$_REQUEST['s'];
						$m=$_REQUEST['m'];
						$qp=mysqli_query($cn,"select * from products where cat_name='$m' and sub_cat_name='$s'")or die ("QF");
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="wholesaler/w/product_photo/<?php echo $datap['photo1'];?>" alt=" " class="img-responsive" />
									<img src="wholesaler/w/product_photo/<?php echo $datap['photo2'];?>" alt=" " class="img-responsive" />
								...
								<h5><a href="product_details.php?p=<?php echo $datap['pid'];?>"><?php echo $datap['Prod_name'];?></a></h5> 
								<div class="simpleCart_shelfItem">
									<p><span><?php echo $datap['selling_price']+100;?></span> <i class="item_price"><?php echo $datap['selling_price'];?></i></p>
									<form action="#" method="post">
						 
											<button type="submit" class="w3ls-cart"> <a href="product_details.php?p=<?php echo $datap['pid'];?>">Buy Now </a></button>
									</form>
								</div> 
								<div class="mobiles_grid_pos">
									<h6><?php echo $datap['Prod_name'];?></h6>
								</div>
							</div>
						</div>
